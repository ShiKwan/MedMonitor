    ...
    render () {
        return (
            ...
            <FormGroup row>
                ...
                <Col sm={9}>
                    <Input type="text" name={this.props.nameFirstName} id="name" placeholder="firstname" onChange={(event) => this.onChanged(event)}  defaultValue={this.props.valueFirstName} />
